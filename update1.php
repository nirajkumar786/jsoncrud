...
INNER JOIN salary ON salary.emp_id = emp.emp_id INNER JOIN dept_emp ON dept_emp.emp_id = emp.emp_id 
INNER JOIN department ON department.dept_id=dept_emp.dept_id WHERE emp.emp_id='$id' ");
