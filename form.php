...
if(isset($_POST['update']))
{
    ...
    $result = mysqli_query($con, "UPDATE `emp` SET `name`='$Name',`dob`='$Dob',
    `gender`='$Gender',`department`='$Department',`dept_manager`='$Dmanager',
    `salary`='$Salary',`join_date`='$join_date' where id=$id ") ;
