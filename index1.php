...
<li class="clr1 active"><a href="index1.php">Home</a></li>
<li class="clr1 "><a href="employee1.php">Employees</a></li>
   </ul>
  </div>
 </div>
</nav>
...
<div class="container">
 <div class="btn-toolbar">
  <a class="btn btn-primary" href="insert1.php"><i class="icon-plus"></i> Insert Data</a>
